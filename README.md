...
<head>
  ...
  <style>
    ...
    body::before {
      content: "";
      background-image: url('https://upload.wikimedia.org/wikipedia/commons/4/41/India_map.svg'); /* India map SVG URL */
...
<body>
  ...
  <footer>
    &copy; <span id="currentYear"></span> Saket Atal. All rights reserved.
  </footer>
